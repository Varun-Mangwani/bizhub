...
export default function Footer() {
  ...
  return (
    <footer className="relative border-t border-[#EAEAEA] bg-[#ECDBCC] pt-20 pb-10">
      <div className="container-px mx-auto max-w-[1440px]">
        <div className="flex flex-col items-start justify-between gap-12 border-b border-[#EAEAEA] pb-14 lg:flex-row lg:items-end">
          <div className="max-w-md">
            <a href="#home" onClick={(e) => { e.preventDefault(); handleNav("#home"); }} className="flex items-center gap-2.5">
              <span className="flex h-9 w-9 items-center justify-center rounded-lg bg-[#000000]">
                <span className="font-[Sora] text-sm font-bold text-[#4169E1]">B</span>
              </span>
        ...
        <div className="flex flex-col items-center justify-between gap-6 pt-8 sm:flex-row">
          ...
          <div className="flex gap-3">
            <a href="#" aria-label="Instagram" className="flex h-9 w-9 items-center justify-center rounded-full border border-[#EAEAEA] text-[#000000] transition-colors hover:border-[#4169E1]">
              <InstagramIcon size={15} />
            </a>
            <a href="#" aria-label="LinkedIn" className="flex h-9 w-9 items-center justify-center rounded-full border border-[#EAEAEA] text-[#000000] transition-colors hover:border-[#4169E1]">
              <LinkedinIcon size={15} />
            </a>
            <a href="#" aria-label="Twitter" className="flex h-9 w-9 items-center justify-center rounded-full border border-[#EAEAEA] text-[#000000] transition-colors hover:border-[#4169E1]">
              <TwitterIcon size={15} />
            </a>
          </div>
        </div>
